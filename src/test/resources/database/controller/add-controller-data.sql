...
VALUES (1, 'customer@example.com', 'Customer', 'One', 'password'),
       (2, 'manager@example.com', 'Manager', 'One', 'password'),
       (3, 'another.customer@example.com', 'Customer', 'Two', 'password');
...
VALUES (1, 'Camry', 'Toyota', 'SEDAN', 2, 40.00),
       ...
       (3, 'Model 3', 'Tesla', 'SEDAN', 1, 120.00);
...
VALUES (1, '2026-07-01', '2026-07-05', NULL, 1, 1),
       ...
       (3, '2026-07-10', '2026-07-15', NULL, 2, 3);
